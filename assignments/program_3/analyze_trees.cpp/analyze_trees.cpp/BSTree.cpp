...
BSTree BSTree::buildTree() {
	...
	if (!wordfile.is_open()){
		...
		//cout << "Adjectives inserted into tree " << endl;
	}
	wordfile.close();

	wordfile.open ("Adverb.txt");
	while (getline(wordfile, w)) {
		bTree.insert(w, "Adverb");
		//cout << "Adverbs inserted into tree " << endl;
	}
	wordfile.close();
	...
	while (getline(wordfile, w)) {
		...
		//cout << "Animals inserted into tree " << endl;
	}
	wordfile.close();

	wordfile.open ("Noun.txt");
	while (getline(wordfile, w)) {
		bTree.insert(w, "Noun");
		//cout << "Nouns inserted into tree " << endl;
	}
	wordfile.close();

	wordfile.open ("Verb.txt");
	while (getline(wordfile, w)) {
		bTree.insert(w, "Verb");
		//cout << "Verbs inserted into tree " << endl;
	}
	wordfile.close();
