...
void BSTree::DeleteNode(int key)
    {
        root = deleteNode(root, key); // This is the fix for the deleting the root problem.
    }								  // Assigning root the root node returned by the function
									  // ensures we do not delete the whole tree.
